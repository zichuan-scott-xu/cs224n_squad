...
def pre_process(args):
    ...
    train_examples, train_eval = process_file(args.train_file, "aug_train", word_counter, char_counter)
    ...
    build_features(args, train_examples, "aug_train", args.train_record_file, word2idx_dict, char2idx_dict)
    ...
    save(args.train_eval_file, train_eval, message="aug train eval")
...
if __name__ == '__main__':
    ...
    # Preprocess dataset
    args_.train_file = './data/augmented_train.json'
